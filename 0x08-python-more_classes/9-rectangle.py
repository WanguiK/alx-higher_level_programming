...
class Rectangle:
    ...
    def __init__(self, width=0, height=0):
        ...
        Args:
            width (int): horizontal length of rectangle, defaults to 0
    ...
    def width(self, value):
        """Args:
            value (int): horizontal length of rectangle
    ...
    def height(self, value):
        """Args:
            value (int): vertical length of rectangle

        Attributes:
            __height (int): vertical length of rectangle
    ...
    def perimeter(self):
        ...
        Attributes:
            __width (int): horizontal length of rectangle
            __height (int): vertical length of rectangle
